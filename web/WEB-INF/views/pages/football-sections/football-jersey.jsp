    ...
    <div class="football-section-container">
        ...
        <div class="football-team-slider-wrapper active" id="national-team-list">
            ...
            <div class="football-team-slider" id="national-team-track">
                <a href="${pageContext.request.contextPath}/football#football-jersey-products" class="football-team-card">
                ...
                <a href="${pageContext.request.contextPath}/football#football-jersey-products" class="football-team-card">
                    ...
                    <span class="football-team-name">Mexico</span>
                </a>
            </div>
        ...
        <div class="football-team-slider-wrapper" id="club-team-list">
            ...
            <div class="football-team-slider" id="club-team-track">
                <a href="${pageContext.request.contextPath}/bong_da/real-madrid" class="football-team-card">
                    <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/juventus" class="football-team-card">
                    <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/liverpool" class="football-team-card">
                    <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/arsenal" class="football-team-card">
                    <div class="football-team-logo-box">
                        <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/manchester-united" class="football-team-card">
                    <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/bayern-munich" class="football-team-card">
                    <div class="football-team-logo-box">
                ...
                <a href="${pageContext.request.contextPath}/bong_da/inter-miami" class="football-team-card">
                    <div class="football-team-logo-box">
